...
```
It is not clear from these scatterplots whether the interaction between education level and years of experience is a significant predictor of salary. However, it looks like the relationship between salary and YOE may not be exactly linear, especially for Master's and PhD groups.
