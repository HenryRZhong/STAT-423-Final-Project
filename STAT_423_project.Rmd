...
Based on all of our previous data, we decided to make our final model based on response variable Salary with predictors `Gender`, `sqrt(Education.Level)`, `Job.Category`, `Education.Level`, and interaction terms of `Education.Level` with the other three predictors, and the interaction term `Gender:sqrt(Education.Level)`. Running the stepwise AIC function, it removed the interaction term `Gender:sqrt(Education.Level)`.
