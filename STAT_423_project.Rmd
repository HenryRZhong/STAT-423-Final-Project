...
knitr::opts_chunk$set(echo = FALSE, fig.width=9, fig.height=5)
library(car)
library(tidyverse)
library(MASS)
library(ggridges)
...
<<<<<<< HEAD
The next question was regarding how big of an impact education level has on salary, and also whether the relationship between salary and years of experience is different for different education groups. This analysis has implications to the financial value of higher education over the course of a career.

```{r message=F}
=======
[rewrite analysis since it was deleted]
```{r}
>>>>>>> ec9185c4b18538f304811672c5d333661dd5bb91
