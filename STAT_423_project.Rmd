...
```{r}
AgeVsExp <- Salary_Data[,c("Age", "Years.of.Experience")]
AgeVsExp$Age <- as.numeric(AgeVsExp$Age)
AgeVsExp$Years.of.Experience <- as.numeric(AgeVsExp$Years.of.Experience)
Age <- as.numeric(AgeVsExp$Age)
Experience <- as.numeric(AgeVsExp$Years.of.Experience)

plot(Age, Experience, main = "Scatterplot of Age vs Experience")
```
